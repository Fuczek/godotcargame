...
var title : String = "LVL 2 Burst Nitrous"
var description : String = "Press [CTRL] to gain a short burst of speed. Holds 5 charges."
var level : int = 2
...
func getNitrousBehaviour(car, delta, boost_vector_direction) -> void:
	if !used:
		...
		if player_data.player_nitro_amount > 0:
			...
			car.apply_central_impulse(boost_vector_direction * 25000)
