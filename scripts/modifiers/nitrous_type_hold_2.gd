...
var title = "LVL 2 Hold Nitrous"
var description = "Hold [CTRL] to gain speed. Holds 8 seconds of charge."
var level : int = 2
...
func getNitrousBehaviour(car, delta, boost_vector_direction) -> void:
	...
	if player_data.player_nitro_amount > 0:
		...
		car.apply_central_impulse(boost_vector_direction * 1000)
